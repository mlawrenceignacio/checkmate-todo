...
const ConfirmationModal = ({ setShowModal }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center z-50">
      <div className="flex flex-col items-center gap-5 text-center p-5 bg-blue-900 dark:bg-gray-800 rounded-lg w-[70%] sm:w-[45%] md:w-[35%] lg:w-[25%] xl:w-[20%] lg:p-7 border border-black bg-opacity-90 shadow-md shadow-black">
        ...
        <div className="flex flex-row w-[100%] justify-evenly p-1">
          <button
            ...
            className="px-3 py-1 rounded-lg bg-blue-600 text-white border-b border-black hover:bg-blue-400 hover:text-black lg:text-lg xl:text-xl"
          >
            Delete
          </button>
          <button
